...
import { BatteryCharging, CalendarDays, Sun, CalendarClock } from "lucide-react";
...
export default function Home() {
    ...
    useEffect(() => {
        const Ref = collection(firebase_DB, "test");
        const Doc = doc(Ref, "doc");
    ...
    return (
        <>
            ...
            <div className="mx-auto py-auto">
                <div className="flex justify-between p-20  py-10 items-center ">
                    <div>
                ...
                <div className="grid gap-4 md:grid-cols-1 lg:grid-cols-3 w-[80%] mx-auto pb-4">
                    <Card>
